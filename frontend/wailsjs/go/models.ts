export namespace app {
	...
	export class MountDTO {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.mountedOn = source["mountedOn"];
	    }
	}
	export class MountsResultDTO {
	    mounts: MountDTO[];
	    error?: ErrorDTO;
	
	    static createFrom(source: any = {}) {
	        return new MountsResultDTO(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.mounts = this.convertValues(source["mounts"], MountDTO);
	...
	export class RunResultDTO {
	    ...
	    static createFrom(source: any = {}) {
	        return new RunResultDTO(source);
	    }
